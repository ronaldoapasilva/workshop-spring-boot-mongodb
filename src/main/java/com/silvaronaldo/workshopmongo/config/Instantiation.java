package com.silvaronaldo.workshopmongo.config;
...
import com.silvaronaldo.workshopmongo.dto.AuthorDTO;
import com.silvaronaldo.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		sdf.setTimeZone(TimeZone.getTimeZone("GMT")); //londres Horário do Meridiano de Greenwich
